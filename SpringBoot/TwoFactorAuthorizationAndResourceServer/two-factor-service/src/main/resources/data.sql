...
insert into users(first_name, last_name, email_id, password, mobile, country, user_type, is_tfa_enabled, tfa_code, tfa_expire_time, tfa_default_type) values('Kite', 'Danie', 'kite_d@gmail.com','$2a$10$4zvDxdC3Y8KcCXCikw9fbuKwTesHxHh.bih7J6OFn22BioKQLdOTC','+916207577745','USA','super_admin','Y','','','SMS');
insert into users(first_name, last_name, email_id, password, mobile, country, user_type, is_tfa_enabled, tfa_code, tfa_expire_time, tfa_default_type) values('William', 'John', 'william_j@gmail.com','$2a$10$96W88y2OvetXaAL2KZpJBe9xq.9ZzWW5DMtSYVNKYm/kyUjnLYKn2','8192508792','USA','admin', 'Y','','','EMAIL');
