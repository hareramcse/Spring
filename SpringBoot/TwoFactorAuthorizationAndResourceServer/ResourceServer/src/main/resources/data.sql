...
insert into users(first_name, last_name, email_id, password, mobile, country, user_type) values('Kite', 'Danie', 'kite_d@gmail.com','$2a$10$4zvDxdC3Y8KcCXCikw9fbuKwTesHxHh.bih7J6OFn22BioKQLdOTC','9902583940','USA','super_admin');
insert into users(first_name, last_name, email_id, password, mobile, country, user_type) values('William', 'John', 'william_j@gmail.com','$2a$10$96W88y2OvetXaAL2KZpJBe9xq.9ZzWW5DMtSYVNKYm/kyUjnLYKn2','8192508792','UK','admin');
